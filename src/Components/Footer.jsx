  ...
  return (
    <div className='max-w-[90%] mx-auto py-16 pb-20 text-gray-950'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 px-12 gap-12 lg:grid-cols-4 lg:col-span-2 justify-between mt-6'>
                ...
                <div>
                    <h6 className='font-semibold green uppercase'>Contact</h6>
                    <ul>
                ...
                <div>
                    <h6 className='font-semibold green uppercase'>Socials</h6>
                    <ul>
                        <li className='py-2 text-sm'>
                ...
                <div>
                    <h6 className='font-semibold green uppercase'>© 2024</h6>
                </div>
        </div>
        </div>
