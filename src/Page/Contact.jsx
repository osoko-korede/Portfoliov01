        ...
        <div className='max-w-[1240px] m-auto mt-20 h-full flex flex-col px-10'>
            ...
            <div className='py-12'>
                <div className='flex md:flex-row flex-col gap-8'>
                        ...
                        <form ref={form} onSubmit={sendEmail}>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                                <div>
                                    ...
                                    <div className="mt-2.5 relative">
                                        <input 
                                            ...
                                            className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-[#E4E5E0] border border-gray-200 rounded-md focus:outline-none focus:border-[#004F43] caret-[#004F43]" 
                                        />
                                ...
                                <div className="sm:col-span-2">
                                    ...
                                    <div className="mt-2.5 relative">
                                        <textarea 
                                            ...
                                            className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-[#E4E5E0] border border-gray-200 rounded-md resize-y focus:outline-none focus:border-[#004F43] caret-[#004F43]" 
                                            rows="4"
                                        />
                                ...
                                <div className="sm:col-span-2">
                                    <button 
                                        type="submit" 
                                        className="inline-flex items-center justify-center w-full px-4 py-4 mt-2 text-base font-semibold text-white transition-all duration-200 bg-[#004F43] border border-transparent rounded-md focus:outline-none hover:bg-[#277166] focus:bg-[#0e2a25]"
                                    >
                                        Send
                                    </button>
                                </div>
                    ...
                    <div className=''>
                        <div>
                            <h2 className='text-base text-green-900 text-center flex flex-row'>Contact</h2>
