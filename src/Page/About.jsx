...
const About = () => {
  return (
    <div className='max-w-[1240px] m-auto mt-20 h-full flex flex-col text-gray-950'>
        <h1 className='text-7xl text-gray-900 font-semibold flex flex-row p-10'>About Me</h1>
        ...
        <div className=''>
            <div className= 'flex flex-col md:flex-row p-10 gap-4'>
                    <h2 className=' font-semibold text-5xl text-gray-900 text-center flex flex-row w-[30%]'>Resume</h2>
                    <ul className='text-2xl text-gray-950 pt-4'>
            ...
            <div className= 'flex flex-col md:flex-row mt-28 p-10 gap-4'>
                <h2 className='text-5xl font-semibold text-gray-900 text-center flex flex-row w-[30%]'>Services</h2>
                <ul className='text-2xl text-gray-950 pt-4'>
            ...
            <div className= 'flex flex-col md:flex-row p-10 gap-4'>
                <h2 className='font-semibold text-5xl text-gray-900 text-center flex flex-row w-[30%]'>Proficiency</h2>
                <ul className='text-2xl text-gray-950 pt-4'>
            ...
            <div className= 'flex flex-col md:flex-row p-10 gap-4'>
                <h2 className='font-semibold text-5xl text-gray-900 text-center flex flex-row w-[30%]'>Experience</h2>
                <ul className='text-2xl text-gray-950 pt-4'>
